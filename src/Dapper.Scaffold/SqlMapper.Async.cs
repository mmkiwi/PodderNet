...
[RequiresDynamicCode("This should be intercepted by DapperAOT")]
    public static partial class SqlMapper
{
    ...
    public static Task<IEnumerable<TReturn>> QueryAsync<TFirst, TSecond, TThird, TReturn>(this IDbConnection cnn,
        ...
        CommandType? commandType = null) => throw new NotImplementedException();
    ...
    public static Task<IEnumerable<TReturn>> QueryAsync<TFirst, TSecond, TThird, TFourth, TReturn>(
        ...
        int? commandTimeout = null, CommandType? commandType = null) => throw new NotImplementedException();
    ...
    /// <param name="commandType">Is it a stored proc or a batch?</param>
    [RequiresDynamicCode("This should be intercepted by DapperAOT")]
    public static Task<DbDataReader> ExecuteReaderAsync(this DbConnection cnn, string sql, object? param = null,
        IDbTransaction? transaction = null, int? commandTimeout = null, CommandType? commandType = null) =>
        throw new NotImplementedException();
    ...
    /// </returns>
    [RequiresDynamicCode("This should be intercepted by DapperAOT")]
    public static IAsyncEnumerable<T> QueryUnbufferedAsync<T>(this DbConnection cnn, string sql,
        object? param = null, DbTransaction? transaction = null, int? commandTimeout = null,
        CommandType? commandType = null)
        => throw new NotImplementedException();
}